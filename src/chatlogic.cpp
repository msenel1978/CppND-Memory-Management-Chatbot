...
ChatLogic::ChatLogic()
{
    ...
    /* Task 5: Moving ChatBot by creating local instance
...
ChatLogic::~ChatLogic()
{
    ...
    /* Task 1:  vector<unique_ptr> -> Not needed anymore
    // delete all nodes
    ...
    */
    ...
    /* Task 4: Instances of GraphEdge are owned by instances of GraphNode
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            // Solved with the help of Udacity knowledge-base:
